...
// const formTest1 = document.forms.form_test1.your_name.value;
...
// test
const formYourNameResponse = document.forms.form_test1.your_name;

formYourNameResponse.addEventListener('input', () => {
  let yourNametest = document.getElementById('your_aname_value');
  yourNametest.textContent = formYourNameResponse.value.length;
});
